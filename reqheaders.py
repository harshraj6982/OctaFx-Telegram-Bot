...
def randomheader():
    headers_dict={'User-Agent': random.choice(headers_useragents),'Cache-Control': 'no-cache','Referer': random.choice(headers_referers) + buildblock(random.randint(50,100))}
    return headers_dict